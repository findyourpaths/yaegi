...
func init() {
	Symbols["github.com/findyourpaths/yaegi/stdlib/unsafe/unsafe"] = map[string]reflect.Value{
		"Symbols": reflect.ValueOf(Symbols),
	}
	Symbols["github.com/findyourpaths/yaegi/yaegi"] = map[string]reflect.Value{
